...
Tag usage| Tags can be used for many purpose: Access Control and Compliance information, Automation tasks, Costing Information, Which resources are needed for generrating reports. However do not have inconsistent tag data, example Department:HumanResources vs Department:HR this will create blindspots in your management and reporting. 
